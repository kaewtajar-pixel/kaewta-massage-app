...
- [ ] สร้างการเชื่อมต่อกับ Google Maps API (ใช้ Map component แทน)

## Testing & Deployment
- [x] เขียน unit tests สำหรับ backend procedures
- [x] ทดสอบระบบจองบริการ
- [x] ทดสอบแดชบอร์ดเจ้าของ
- [ ] ปรับแต่งประสิทธิภาพและ responsive design
- [ ] สร้าง checkpoint สำหรับการเผยแพร่
